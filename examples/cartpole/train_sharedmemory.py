...
from parllel.patterns import build_cages_and_core_batch_buffers
from parllel.runners.onpolicy import OnPolicyRunner
from parllel.samplers.basic import BasicSampler
from parllel.samplers.collections import Samples, AgentSamplesWBootstrap
...
def build():
    ...
    with build_cages_and_core_batch_buffers(
            ...
            parallel=parallel,
        ) as (cages, batch_action, batch_env_samples):
        ...
        batch_env_samples.observation[0, 0] = obs_space.sample()
        example_obs = batch_env_samples.observation[0, 0]
        ...
        try:
            ...
            agent.close()
            buffer_method(batch_agent_info, "close")
            buffer_method(batch_bootstrap_value, "destroy")
            buffer_method(batch_agent_info, "close")
            buffer_method(batch_bootstrap_value, "destroy")
