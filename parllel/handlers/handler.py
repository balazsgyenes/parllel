...
class Handler:
    ...
    def step(self, observation: Buffer, previous_action: Buffer, previous_reward: Buffer, *,
        ...
        agent_step: AgentStep = self._agent(observation, previous_action, previous_reward, env_ids=env_ids)
        if None in {out_action, out_agent_info}:
            return agent_step
        else:
    ...
    def value(self, observation: Buffer, previous_action: Buffer, previous_reward: Buffer, *, 
        ...
        val: Buffer = self._agent(observation, previous_action, previous_reward, env_ids=env_ids)
